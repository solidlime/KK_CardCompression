# KK Card Compression v1.3.0

<p align="center">
  <img src="Assets/app-icon.png" alt="KKCC" width="240" />
</p>
...
- シーンファイルで約 **40-50%** 削減
- 埋め込み PNG のロスレス再圧縮により更に **10-18%** 削減
- バイト単位で完全復元（ロスレス）
- **並列バッチ処理**で複数ファイルを高速処理
...
- 圧縮形式は LZMA（マーカー 101）のみ対応。Zstd 形式（102, 103）には非対応。
